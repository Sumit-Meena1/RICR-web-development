...
import ResetRestaurantPasswordModal from "./modals/ResetRestaurantPasswordModal";
  ...
  return (
    <>
      ...
      {isEditRestaurantProfileModalOpen && (
        <EditRestaurantProfileModal onClose={() => setIsEditRestaurantProfileModalOpen(false)} />
      )}

      {isResetRestaurantPasswordModalOpen && (
        <ResetRestaurantPasswordModal
